...
scrollFrame.CanvasSize = UDim2.new(0, 0, 0, 770) -- Increased to fit ESP button
...
-- ESP TOGGLE
toggles.esp = createToggle("ESP (NAMES/LINES/HP/DIST)", 4, function(active)
    Config.esp = active
end)
...
-- ==========================================
-- CORE SCRIPTS (FLYING, ENFORCEMENTS, ANTI-AFK, ESP RENDER)
-- ==========================================
...
RunService.RenderStepped:Connect(function()
    ...
    if Config.esp then
        ...
        for plr, objs in pairs(espObjects) do
            ...
            if targetChar and targetHead and targetHum and targetHum.Health > 0 and myHead then
                ...
                if onScreen and myOnScreen then
                    -- 1. Setup Info Label (Name, HP, Dist)
        ...
        -- Hide all ESP elements if toggled off
