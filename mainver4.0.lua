...
-- ==========================================
-- FLOATING ROUND MENU BUTTON (ULTRA-SMOOTH DRAG)
-- ==========================================
...
toggles.controls = createToggle("SHOW CONTROLS", 4, function(active)
...
toggles.spin = createToggle("SPIN PLAYER", 5, function(active)
...
toggles.god = createToggle("GOD MODE", 6, function(active) Config.godMode = active end)
...
toggles.invisible = createToggle("INVISIBLE", 7, function(active)
    Config.invisible = active
    setInvisibility(player.Character, active)
end)

createButton("FORCE FIRST PERSON", Color3.fromRGB(60, 100, 200), 8, function() player.CameraMode = Enum.CameraMode.LockFirstPerson end)
createButton("FORCE THIRD PERSON", Color3.fromRGB(60, 180, 200), 9, function()
...
createButton("RESET SETTINGS", Color3.fromRGB(200, 100, 0), 10, function()
...
createButton("RESET CHARACTER", Color3.fromRGB(200, 50, 50), 11, function()
...
openBtn.MouseButton1Click:Connect(function()
    -- Prevent opening if we are just dragging it
...
-- ==========================================
-- CORE SCRIPTS (FLYING, ENFORCEMENTS, ANTI-AFK)
-- ==========================================
...
-- Heartbeat checks run EVERY FRAME to strictly enforce settings
RunService.Heartbeat:Connect(function()
    ...
    -- FORCE Speed & Jump (prevents the game from reverting it)
...
player.CharacterAdded:Connect(function(char)
    ...
    if Config.invisible then
        task.wait(0.5) -- wait for accessories to load
