...
-- ============================================================================
-- 7. 100% DIVINE CUSTOMER OVERRIDE (NO RANDOM VIPs)
-- ============================================================================
...
Bakery.AddCustomersToQueueIfNecessary = function(bakery, kick, UIDBatch)
    ...
    if Config.ForceVIP then
        -- Set this to the exact ID of the Divine Customer 
        local divineID = '38' 
        
        for i, data in pairs(UIDBatch) do
            -- Force EVERY single customer in the batch to be Divine, no exceptions
            UIDBatch[i].ID = divineID
        end
    end
...
-- ============================================================================
-- 10. ADVANCED UI LOADER (RAYFIELD OVERRIDE v5.5 - TOTALLY ISOLATED)
-- ============================================================================
...
Toggles["Force VIP Customers"] = FarmTab:CreateToggle({ Name = "Force 100% Divine Customers", CurrentValue = Config.ForceVIP, Callback = function(v) Config.ForceVIP = v end })
...
InfoTab:CreateLabel("VERSION: v5.5 (Granular Task Link Override)")

Rayfield:Notify({ Title = "DZ Hacker Script Loaded", Content = "Welcome Dhwanit Zala. v5.5 Engine active.", Duration = 6, Image = 4483362458 })

print("========================================")
print("  MADE BY DZ HACKER (DHWANIT ZALA)")
print("  TELEGRAM: t.me/DZHACKER456")
print("  INSTA: @dhwanitzala")
print("  STATUS: v5.5 Successfully Injected!")
print("========================================")
