...
sliders.walkSpeed = createSlider("WALK SPEED", 16, 500, DefaultConfig.walkSpeed, 2, function(val)
    Config.walkSpeed = val
    local hum = player.Character and player.Character:FindFirstChildOfClass("Humanoid")
    if hum then hum.WalkSpeed = val end
end)

sliders.jumpPower = createSlider("JUMP POWER", 50, 500, DefaultConfig.jumpPower, 3, function(val)
...
toggles.god = createToggle("GOD MODE", 6, function(active)
    Config.godMode = active
end)

-- CAMERA BUTTONS
createButton("FORCE FIRST PERSON", Color3.fromRGB(60, 100, 200), 7, function()
...
createButton("RESET SETTINGS", Color3.fromRGB(200, 100, 0), 9, function()
...
createButton("RESET CHARACTER", Color3.fromRGB(200, 50, 50), 10, function()
